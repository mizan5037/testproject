...
function customPageHeader()
{
    ...
    <!--Arbitrary HTML Tags-->
<?php }
include_once "controller/fabric_issue_stock.php";
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Fabric Issue Stock
                    <div class="page-title-subheading">
                        Fabric Issue Stock Details
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        <tr>
                            ...
                            <td> <a href="<?=$path?>/index.php?page=single_fab_issue_stock&fabissueid=<?= $row['FabIssueID'] ?>" class="btn btn-sm btn-primary">Details</a> </td>
                        </tr>
                    <?php
                    }
