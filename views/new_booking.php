...
$PageTitle = "New Booking | Optima Inventory";
            ...
            <div class="page-title-heading">
                ...
                <div>New Booking
                    <div class="page-title-subheading">
                        Please use this form to add a new Booking.
                    </div>
                </div>
            </div>
        </div>
            ...
            <form class="needs-validation" id="form" method="post" novalidate>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="masterlcid" class="item mb-2 form-control-sm form-control search_select" required>
                            <option></option>
                            <?php
