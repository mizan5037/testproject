            ...
            <form class="needs-validation" method="POST" novalidate>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="style" class="style  form-control" required disabled>
                            <?php
                            $styleid = $single_cutting['StyleID'];
                            $sql = "SELECT * FROM style WHERE status = '1' AND StyleID = '$styleid'";
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationTooltip02" placeholder="Cutting no" name="cutting_no" value="<?= $single_cutting['CuttingNo'] ?>" required disabled>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="validationTooltipUsername">PO no</label>
                        <select name="po" class="po  form-control" required disabled>
                            <?php
                            $poid = $single_cutting['POID'];
                            $sql = "SELECT * FROM po WHERE status = '1' AND POID = '$poid'";
                            $results = mysqli_query($conn, $sql);
                            while ($result = mysqli_fetch_assoc($results)) {
